...
\subsection{Komponens és integrációs tesztelés}
	...
	Az átfogó tesztelés a ServerConfig/test.erl fájlban található. 
		...
		\item[test:runCheck, run] \hfill \\
			...
			A main-ben található függvény tesztelésére a test:simulateDistributedCalculate függvényt használjuk, amit a bin/run.erl-ben lévő teszt futtat.
